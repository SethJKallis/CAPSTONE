<template>
  ...
  <div class="container-fluid">
    <a class="navbar-brand m-0 p-0" href="#"><img src="../assets/sitelogo.png" alt="Site Logo" width="50" height="50"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mb-lg-0 d-flex justify-content-between w-100">
        ...
        <div class="lastRoutes me-lg-3 text-center mx-auto px-auto">
